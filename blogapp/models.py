...
class EditorProfile(models.Model):
        ...
        name= models.CharField(max_length=30,default="dział")
        lastname=models.CharField(max_length=30,default="redakcyjny")
        avatar = models.ImageField()
        slug = models.CharField(max_length=128,null=True,blank=True)
        description = models.TextField()
        rank = models.CharField(max_length=100,default="Redaktor")
        def __str__(self):
